package com.season.common.web.resolver;
...
public class MethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(MethodArgumentResolver.class);

	/**
	 * 参数结构缓存
	 */
	private Map<MethodParameter, ParamInfo> paramInfoCache
			= new ConcurrentHashMap<MethodParameter, ParamInfo>(256);
